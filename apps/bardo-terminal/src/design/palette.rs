...
pub use crate::palette::{
    ...
    DANGER, DREAM, DREAM_DEEP, DREAM_DIM, NOISE_COOL, NOISE_WARM, PHOSPHOR_RES, ROSE, ROSE_BRIGHT,
    ROSE_DEEP, ROSE_DIM, ROSE_EMBER, SCANLINE_DARK, SUCCESS, TEXT_DIM, TEXT_GHOST, TEXT_PHANTOM,
